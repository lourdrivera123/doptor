 ...
 */
  ...
  // Route::get('gsl', function(){
  //   return LaravelLocalization::getSupportedLocales();
  // });

  Route::get('testing_language', function(){
        return trans('cms.user_manager');
    // return 'asd';
  });
...
Route::resource('languages', 'Components\Languages\Controllers\LanguagesController');
